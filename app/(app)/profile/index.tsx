...
const getStyles = (colors: ReturnType<typeof getColors>) => StyleSheet.create({
  ...
  buttonGroup: { flexDirection: 'row', gap: spacing.xs, alignItems: 'center', flexShrink: 0 },
  editBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  editBtnText: { color: colors.primary, fontSize: 12, fontWeight: '700', letterSpacing: 0.1 },
  filterBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  filterBtnText: { color: colors.success, fontSize: 12, fontWeight: '700', letterSpacing: 0.1 },
